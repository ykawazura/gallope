...
module force
  ...
  complex(8), allocatable, dimension(:,:,:) :: fzpx
  complex(8), allocatable, dimension(:,:,:) :: fzpy
  complex(8), allocatable, dimension(:,:,:) :: fzpz
  complex(8), allocatable, dimension(:,:,:) :: fzmx
  complex(8), allocatable, dimension(:,:,:) :: fzmy
  complex(8), allocatable, dimension(:,:,:) :: fzmz
