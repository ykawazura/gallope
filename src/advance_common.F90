...
!-----------------------------------------------!
  subroutine eSSPIFRK1(u1, u0, exp_terms0, imp_tintg1, imp_tintg0)
    !$acc routine seq
    implicit none
    complex(8), intent (out) :: u1
    complex(8), intent (in ) :: u0, exp_terms0
    real   (8), intent (in ) :: imp_tintg1, imp_tintg0
  ...
  subroutine eSSPIFRK2(u2, u1, u0, exp_terms1, imp_tintg2, imp_tintg0)
    !$acc routine seq
    implicit none
    complex(8), intent (out) :: u2
    complex(8), intent (in ) :: u1, u0, exp_terms1
    real   (8), intent (in ) :: imp_tintg2, imp_tintg0
  ...
  subroutine eSSPIFRK3(unew, u2, u0, exp_terms2, exp_terms0, imp_tintg3, imp_tintg2, imp_tintg0)
    !$acc routine seq
    implicit none
    complex(8), intent (out) :: unew
    complex(8), intent (in ) :: u2, u0, exp_terms2, exp_terms0
    real   (8), intent (in ) :: imp_tintg3, imp_tintg2, imp_tintg0
...
!-----------------------------------------------!
  subroutine gear1(unew, u, exp_terms, imp_terms)
    ...
    implicit none
    complex(8), intent (out) :: unew
    complex(8), intent (in ) :: u, exp_terms
    real   (8), intent (in ) :: imp_terms
  ...
  subroutine gear2(unew, u, uold1, exp_terms, exp_terms_old1, imp_terms)
    ...
    implicit none
    complex(8), intent (out) :: unew
    complex(8), intent (in ) :: u, uold1, exp_terms, exp_terms_old1
    real   (8), intent (in ) :: imp_terms
  ...
  subroutine gear3(unew, u, uold1, uold2, exp_terms, exp_terms_old1, exp_terms_old2, imp_terms)
    ...
    implicit none
    complex(8), intent (out) :: unew
    complex(8), intent (in ) :: u, uold1, uold2, exp_terms, exp_terms_old1, exp_terms_old2
    real   (8), intent (in ) :: imp_terms
